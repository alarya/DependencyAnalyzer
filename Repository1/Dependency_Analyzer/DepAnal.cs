...
{ 
    public class DepAnal
    {
        ...
        //------------------------Relationship analysis request as xml string----------------------------------------------------------------------//
        public static string RelationshipAnalysis()
        {
            Dictionary<string,List<CodeAnalysis.Relationships>> temp = CodeAnalysis.Analyzer.parse2("../../../CodeAnalyzer/Parser", true, "*.cs"); 
            XDocument doc = new XDocument();
